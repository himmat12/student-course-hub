<?php
$base_path =  '/web-project-the-a-team/pages/admin';
        ...
        <div class="navbar-top-section">
            ...
            <div class="sidebar-menu">
                ...
                <a class="sidebar-link" href="<?= $base_path ?>/programmes">
                    <div class="menu-item" id="programmes-menu-item">Programmes</div>
                </a>
                <a class="sidebar-link" href="<?= $base_path ?>/modules">
                    <div class="menu-item" id="modules-menu-item">Modules</div>
                </a>
                <a class="sidebar-link" href="<?= $base_path ?>/students">
                    <div class="menu-item" id="students-menu-item">Student Interests</div>
                </a>
